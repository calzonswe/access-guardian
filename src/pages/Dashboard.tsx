...
export default function Dashboard() {
  ...
  const renderAdminDashboard = () => (
    <>
      ...
      <ApplicationTable applications={applications} title="Alla ansökningar" />
    </>
  );
  ...
  const renderFacilityDashboard = () => {
    ...
    return (
      <>
        ...
        {exceptions.length > 0 && <ApplicationTable applications={exceptions} title="Avsteg som kräver godkännande" />}
